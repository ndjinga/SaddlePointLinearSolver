...
int main( int argc, char **args ){
	...
	PetscInt n_u, n_p, n_omega;//Total number of velocity, pressure and vorticity lines. n = n_u+ n_p + n_omega
...
//##### Calling KSP solver and monitor convergence
    ...
    solveSchurSystemForXoutput( A_input, is_U, is_P, b_input, &X_output, rtol,PETSC_DEFAULT,PETSC_DEFAULT, PETSC_DEFAULT, &residu);
