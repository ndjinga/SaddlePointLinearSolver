...
The following notebook provides detailed analysis and insights related to the performance of the solver. 

It uses the merged CSV file generated by the commands described earlier in this README.

[tests/performance_analysis.ipynb](tests/performance_analysis.ipynb)